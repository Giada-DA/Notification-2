...
public class StudentService {
    ...
    static List<Student> students = Arrays.asList(
            new Student("1", "John", "Walker", "giadadallara00@gmail.com"),
            new Student("2", "Francesco", "Petrarca", "francesco.petrarca@gmail.com"),
            new Student("3", "Ludovico", "Ariosto", "ludovico.ariosto@gmail.com"),
            new Student("4", "Tommaso", "Campanella", "tommaso.campanella@gmail.com")
            );
